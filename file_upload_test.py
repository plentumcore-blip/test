...
class FileUploadTester:
    ...
    def test_static_file_access(self):
        ...
        known_files = [
            "https://influ-pages.preview.emergentagent.com/api/uploads/06e5e39b-0189-4655-9226-b44c845487cb.png",
            "https://influ-pages.preview.emergentagent.com/api/uploads/2274ea0a-5ef4-4871-932c-14e586a035c7.png"
        ]
        ...
        for file_url in self.uploaded_files:
            # Check URL format
            if file_url.startswith("https://influ-pages.preview.emergentagent.com/api/uploads/"):
