...
class APITester:
            ...
            if response.status_code == 200:
                ...
                if "/api/redirect/" in redirect_url:
                    ...
                    try:
                        ...
                        base_domain = "https://influ-pages.preview.emergentagent.com"
    ...
    def test_file_upload_and_static_serving_fix(self):
        ...
        try:
            ...
            existing_file_url = "https://influ-pages.preview.emergentagent.com/api/uploads/06e5e39b-0189-4655-9226-b44c845487cb.png"
        ...
        if hasattr(self, 'uploaded_filename'):
            try:
                ...
                old_path_url = f"https://influ-pages.preview.emergentagent.com/uploads/{self.uploaded_filename}"
