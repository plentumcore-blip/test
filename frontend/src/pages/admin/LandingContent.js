...
import { Save, Plus, Trash2, Video, BarChart3, Upload, Check, Image } from 'lucide-react';
                          ...
                          <div>
                            ...
                            <div className="w-64 aspect-[9/16] bg-slate-100 rounded-lg overflow-hidden">
                              {video.uploadType === 'youtube' && video.videoUrl.includes('youtube.com') ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-red-500 to-pink-500 text-white">
